...
void glfwInitVk(int index, void *pParams);
void glfwCreateWindowMacOS(int wWidth, int wHeight, int index);
void glfwCreateVkChain(int index);
void glfwFnctPtrCall(void (*f)(void*), void *params);
GLFWwindow	*glfwGetWindowHandle(int index);

void glfwVkUpdateBuffer();
void glfwVkFillBuffer(size_t index, float value);
void glfwVkSync();
void glfwVkDraw();

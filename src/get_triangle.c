...
void	add_color(float *pos, float *color)
{
	...
	{
		color[0] = 255.f / 255.f * size * size;
		color[1] = 222.f / 255.f * size * size;
		color[2] = 173.f / 255.f * size * size;
	}
	else if (size < 1.17f)
	{
	...
	if (size > 1.17f)
	{
		color[0] = 0.55f * (size * size * size);
		color[1] = 0.55f * (size * size * size);
		color[2] = 0.55f * (size * size * size);
	}
}
